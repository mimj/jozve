...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitForm() {
                let previousPagePosition = this.prevPagePosition;
                ...
                this.$store.dispatch('topics/addPageTitleToTopic',
                    Object.assign({}, {
                        'title': this.title,
                        prevPagePosition: previousPagePosition,
                    ...
                    .then((res) => {
                        ...
                        EventManager.fire('hide');
                        debugger
                        EventManager.fire('updateSubPageTitles', {parent_id: this.parent_id, newPage: res});
                        if (res.parent_id === 0) {
                            // debugger
                            EventManager.fire('forceUpdate', this.$store.state.topics.currentTopic.pages)
                        }
                    }).catch(() => {
